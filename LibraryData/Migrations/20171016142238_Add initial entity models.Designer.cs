...
namespace LibraryData.Migrations
{
    ...
    [Migration("20171016142238_Add initial entity models")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryData.Models.CheckoutHistory", b =>
                {
                    ...
                    b.Property<int>("GetLibraryAssetId");

                    b.Property<int>("LibraryCardId");

                    b.HasKey("Id");

                    b.HasIndex("GetLibraryAssetId");
            ...
            modelBuilder.Entity("LibraryData.Models.CheckoutHistory", b =>
                {
                    b.HasOne("LibraryData.Models.LibraryAsset", "GetLibraryAsset")
                        .WithMany()
                        .HasForeignKey("GetLibraryAssetId")
                        .OnDelete(DeleteBehavior.Cascade);
